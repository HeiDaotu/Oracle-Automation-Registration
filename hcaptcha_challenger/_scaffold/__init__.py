...
def get_challenge_ctx(
    ...
    # - Restrict browser startup parameters  限制浏览器启动参数
    options = uc.ChromeOptions()
    options.add_argument("--log-level=3")
    options.add_argument("--disable-dev-shm-usage")

    # - Restrict the language of hCaptcha label                         -限制hCaptcha标签的语言
    # - Environment variables are valid only in the current process     -环境变量仅在当前进程中有效
    # and do not affect other processes in the operating system         并且不影响操作系统中的其他进程
